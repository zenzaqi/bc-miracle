...
WHERE detail_pakai_cabin.cabin_dtrawat=tindakan_detail.dtrawat_id
AND tindakan.trawat_id=tindakan_detail.dtrawat_master;

CREATE OR REPLACE VIEW `miracledb`.`vu_stok_new`
AS
