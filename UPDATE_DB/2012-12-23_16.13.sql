...
ALTER TABLE `customer`  COMMENT='',  CHANGE COLUMN `cust_referensilain` `cust_referensilain` ENUM('Lewat', 'Billboard','Keluarga','Teman','Dokter klinik','Miracle cabang lain','Staff','Event','Koran','Brosur','Majalah','Senam','Radio','Lain-lain') NULL DEFAULT NULL AFTER `cust_referensi`;
