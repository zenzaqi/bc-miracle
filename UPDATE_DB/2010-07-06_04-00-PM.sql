...
UPDATE voucher_terima A,
       master_jual_produk B
   SET A.tvoucher_date_create = B.jproduk_tanggal
 WHERE A.tvoucher_ref = B.jproduk_nobukti;
...
UPDATE voucher_terima A,
       master_jual_rawat B
   SET A.tvoucher_date_create = B.jrawat_tanggal
 WHERE A.tvoucher_ref = B.jrawat_nobukti;
...
UPDATE voucher_terima A,
       master_jual_paket B
   SET A.tvoucher_date_create = B.jpaket_tanggal
 WHERE A.tvoucher_ref = B.jpaket_nobukti;
...
UPDATE voucher_terima A,
       cetak_kwitansi B
   SET A.tvoucher_date_create = B.kwitansi_tanggal
 WHERE A.tvoucher_ref = B.kwitansi_no;
...
WHERE A.jcard_ref=B.jproduk_nobukti AND  A.jcard_transaksi is NULL;

UPDATE  jual_card A, 
        master_jual_rawat B
SET A.jcard_transaksi='jual_rawat'
WHERE A.jcard_ref=B.jrawat_nobukti AND  A.jcard_transaksi is NULL;

UPDATE  jual_card A, 
        master_jual_paket B
SET A.jcard_transaksi='jual_paket'
WHERE A.jcard_ref=B.jpaket_nobukti AND  A.jcard_transaksi is NULL;

UPDATE  jual_card A, 
        cetak_kwitansi B
SET A.jcard_transaksi='jual_kwitansi'
WHERE A.jcard_ref=B.kwitansi_no AND  A.jcard_transaksi is NULL;
...
WHERE A.jcek_ref=B.jproduk_nobukti AND  A.jcek_transaksi is NULL;

UPDATE  jual_cek A, 
        master_jual_rawat B
SET A.jcek_transaksi='jual_rawat'
WHERE A.jcek_ref=B.jrawat_nobukti AND  A.jcek_transaksi is NULL;

UPDATE  jual_cek A, 
        master_jual_paket B
SET A.jcek_transaksi='jual_paket'
WHERE A.jcek_ref=B.jpaket_nobukti AND  A.jcek_transaksi is NULL;

UPDATE  jual_cek A, 
        cetak_kwitansi B
SET A.jcek_transaksi='jual_kwitansi'
WHERE A.jcek_ref=B.kwitansi_no AND  A.jcek_transaksi is NULL;
...
WHERE A.jtransfer_ref=B.jproduk_nobukti AND  A.jtransfer_transaksi is NULL;

UPDATE  jual_transfer A, 
        master_jual_rawat B
SET A.jtransfer_transaksi='jual_rawat'
WHERE A.jtransfer_ref=B.jrawat_nobukti AND  A.jtransfer_transaksi is NULL;

UPDATE  jual_transfer A, 
        master_jual_paket B
SET A.jtransfer_transaksi='jual_paket'
WHERE A.jtransfer_ref=B.jpaket_nobukti AND  A.jtransfer_transaksi is NULL;

UPDATE  jual_transfer A, 
        cetak_kwitansi B
SET A.jtransfer_transaksi='jual_kwitansi'
WHERE A.jtransfer_ref=B.kwitansi_no AND  A.jtransfer_transaksi is NULL;
...
WHERE A.jkredit_ref=B.jproduk_nobukti AND  A.jkredit_transaksi is NULL;

UPDATE  jual_kredit A, 
        master_jual_rawat B
SET A.jkredit_transaksi='jual_rawat'
WHERE A.jkredit_ref=B.jrawat_nobukti AND  A.jkredit_transaksi is NULL;

UPDATE  jual_kredit A, 
        master_jual_paket B
SET A.jkredit_transaksi='jual_paket'
WHERE A.jkredit_ref=B.jpaket_nobukti AND  A.jkredit_transaksi is NULL;

UPDATE  jual_kredit A, 
        cetak_kwitansi B
SET A.jkredit_transaksi='jual_kwitansi'
WHERE A.jkredit_ref=B.kwitansi_no AND  A.jkredit_transaksi is NULL;



UPDATE  voucher_terima A, 
        master_jual_produk B
SET A.tvoucher_transaksi='jual_produk'
WHERE A.tvoucher_ref=B.jproduk_nobukti AND  A.tvoucher_transaksi is NULL;

UPDATE  voucher_terima A, 
        master_jual_rawat B
SET A.tvoucher_transaksi='jual_rawat'
WHERE A.tvoucher_ref=B.jrawat_nobukti AND  A.tvoucher_transaksi is NULL;

UPDATE  voucher_terima A, 
        master_jual_paket B
SET A.tvoucher_transaksi='jual_paket'
WHERE A.tvoucher_ref=B.jpaket_nobukti AND  A.tvoucher_transaksi is NULL;

UPDATE  voucher_terima A, 
        cetak_kwitansi B
SET A.tvoucher_transaksi='jual_kwitansi'
WHERE A.tvoucher_ref=B.kwitansi_no AND  A.tvoucher_transaksi is NULL;