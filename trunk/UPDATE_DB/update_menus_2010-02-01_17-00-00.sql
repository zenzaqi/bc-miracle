...
--
-- Host: localhost
-- Generation Time: Feb 01, 2010 at 06:01 PM
...
CREATE TABLE IF NOT EXISTS `menus` (
  ...
  `menu_cat` enum('window','url') NOT NULL default 'window',
  `menu_confirm` enum('Y','N') NOT NULL default 'N',
  `menu_leftpanel` enum('N','Y') NOT NULL default 'N',
  `menu_iconpanel` varchar(50) default NULL,
  `menu_iconmenu` varchar(50) default NULL,
  PRIMARY KEY  (`menu_id`)
