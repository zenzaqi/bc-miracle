...
ALTER TABLE `customer`  CHANGE COLUMN `cust_profesi` `cust_profesi` ENUM('Pelajar / Mahasiswa', 'Ibu Rumah Tangga', 'Karyawan / Swasta', 'Wiraswasta', 'Profesional', 'Selebritis', 'Lain-lain') NULL DEFAULT NULL AFTER `cust_revised`;
