...
class C_cabang extends Controller {
	...
	function cabang_print(){
		...
		fwrite($file, "<body><table summary='Cabang List'><caption>CABANG</caption><thead><tr><th scope='col'>Cabang Id</th><th scope='col'>Cabang Nama</th><th scope='col'>Cabang Alamat</th><th scope='col'>Cabang Kota</th><th scope='col'>Cabang Kode Pos</th><th scope='col'>Cabang Propinsi</th><th scope='col'>Cabang Keterangan</th><th scope='col'>Cabang Aktif</th></tr></thead><tfoot><tr><th scope='row'>Total</th><td colspan='$totcolumn'>");
		fwrite($file, $nbrows);
