	...
	function customer_check_paket($cust_id, $rawat_id){
		...
		if($rs_punya_paket->num_rows()){
			...
			foreach($rs_punya_paket->result() as $row_punya_paket){
				$i++;
				/*$this->firephp->log($row_punya_paket, "row_punya_paket");
				$this->firephp->log($rawat_id, "rawat_id");
				$this->firephp->log($row_punya_paket->dpaket_id, "dpaket_id");
				$this->firephp->log($row_punya_paket->dpaket_master, "dpaket_master");
				$this->firephp->log($row_punya_paket->dpaket_paket, "dpaket_paket");*/
				...
				if($rs_check_sisa->num_rows()){
					...
					//$total_item_terpakai = $record_check_sisa['total_item_terpakai'];
					//$this->firephp->log($row_punya_paket->rpaket_jumlah,'rpaket_jumlah');
					//$this->firephp->log($record_check_sisa->total_item_terpakai,'terpakai');
					if($row_punya_paket->rpaket_jumlah > $record_check_sisa->total_item_terpakai){
						//$this->firephp->log('cocok iwak endog');
						//$this->firephp->log($row_punya_paket->dpaket_master, 'dpaket_master');
