	...
	function report_tindakan_search($report_tindakan_id ,$trawat_tglapp_start ,$trawat_tglapp_end ,$trawat_dokter, $report_groupby, $start,$end){
			...
			$query="select rawat_kode as rawat_kode, rawat_nama as rawat_nama, sum(Jumlah_rawat) as Jumlah_rawat, rawat_kredit as rawat_kredit, total_kredit as Total_Kredit, sum(Total_kredit) as Total_kredit 
						from(
							...
							where (jrawat_tanggal BETWEEN '".$trawat_tglapp_start."' AND '".$trawat_tglapp_end."') and (rawat_id is not null and jrawat_stat_dok='Tertutup') and (dokter.karyawan_id ='".$trawat_dokter."' or terapis.karyawan_id = '".$trawat_dokter."' or referal.karyawan_id = '".$trawat_dokter."' or detail_jual_rawat.drawat_sales = '".$trawat_dokter."' or tindakan_detail.dtrawat_petugas1 = '".$trawat_dokter."' or tindakan_detail.dtrawat_petugas2 = '".$trawat_dokter."')
							...
							where (dapaket_tgl_ambil BETWEEN '".$trawat_tglapp_start."' AND '".$trawat_tglapp_end."') and (karyawan_id = '".$trawat_dokter."' and rawat_id is not null and dapaket_stat_dok='Tertutup')
							group by karyawan.karyawan_username,perawatan.rawat_nama
							)
							) as table_union
							group by karyawan_username, rawat_nama
							";
	...
	function report_tindakan_search2($report_tindakan_id ,$trawat_tglapp_start ,$trawat_tglapp_end ,$trawat_dokter, $report_groupby, $start,$end){
			...
			$query="select sum(vu_kredit.Total_kredit) as grand_total 
						from(
							...
							left join karyawan on(karyawan.karyawan_id=detail_ambil_paket.dapaket_referal)
							where (dapaket_tgl_ambil BETWEEN '".$trawat_tglapp_start."' AND '".$trawat_tglapp_end."') and (karyawan_id = '".$trawat_dokter."' and rawat_id is not null and dapaket_stat_dok='Tertutup')
							group by karyawan.karyawan_username,perawatan.rawat_nama) as vu_kredit";
