...
<title>Laporan Detail Penyesuaian Stok <?php echo $periode; ?> Group By No. Bukti</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Detail Jual'>
	<caption>Laporan Detail Penyesuaian Stok <br/><?php echo $periode; ?><br/>Group By No. Bukti</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
			...
			?>
			<?php if($group!==$print->no_bukti) { ?>
           <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="9"><b><?php echo "No PS : ".$print->no_bukti.", Tanggal :".$print->tanggal.", Gudang : ".$print->gudang_nama; ?></b></td>
           </tr>
           <?php 	
		   			$sub_awal=0;
					$sub_koreksi=0;
