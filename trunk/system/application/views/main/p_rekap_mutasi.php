...
<title>Laporan Rekap Mutasi <?php echo $jenis; ?> <?php echo $periode; ?> Group By No. Bukti</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Rekap Jual'>
	<caption>Laporan Rekap Mutasi <br/><?php echo $periode; ?><br/>Group By  No. Bukti</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
