...
<title>Laporan Tindakan Medis <?php echo $periode; ?> Group By Perawatan</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Detail Jual'>
	<caption>Laporan Tindakan Medis <br/><?php echo $periode; ?><br/>Group By Perawatan</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
        ...
        <?php $i=0; $j=0; $tanggal=""; 
			...
			<?php if($tanggal!==$print->dtrawat_perawatan) { ?>
           <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="7"><b><?php echo $print->rawat_nama;?></b></td>
           </tr>
           <?php 	
					$i=0; 
			?>
           <?php foreach($data_print as $print_list) {  ?>
           <?php if($print_list->dtrawat_perawatan==$print->dtrawat_perawatan){ $i++;
		   ...
		   ?>
            <tr>
				...
				<td><?php echo $print_list->dokter_nama; ?></td>
           ...
           <?php } $tanggal=$print->dtrawat_perawatan; ?>
		<?php } ?>
