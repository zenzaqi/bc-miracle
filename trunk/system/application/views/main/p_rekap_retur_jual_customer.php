...
<title>Laporan Rekap Penjualan <?php echo $periode; ?> Group By No Customer</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print()">
<table summary='Rekap Retur Jual'>
	<caption>Laporan Rekap  Retur Penjualan <br/><?php echo $periode; ?><br/> Group By Customer</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
        ...
        <tr>
            ...
            <td scope='col' colspan="7"><b><?php echo $printlist->cust_nama." (".$printlist->cust_no.")";  ?></b></td>
        </tr>
        <?php
				$i=0;
				$sub_item=0;
