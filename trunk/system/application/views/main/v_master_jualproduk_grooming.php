   ...
   /* function load_membership(){
	...
	function master_jpgrooming_confirm_delete(){
		...
		if(master_jpgroomingListEditorGrid.selModel.getCount() == 1){
			Ext.MessageBox.confirm('Confirmation','Are you sure to delete this record?', master_jpgrooming_SelectedRow_delete);
		} else if(master_jpgroomingListEditorGrid.selModel.getCount() > 1){
			Ext.MessageBox.confirm('Confirmation','Are you sure to delete these records?', master_jpgrooming_SelectedRow_delete);
		} else {
			Ext.MessageBox.show({
				title: 'Warning',
...
*/
	...
	function detail_jpgrooming_confirm_delete(){
		...
		if(detail_jpgroomingListEditorGrid.selModel.getCount() == 1){
			Ext.MessageBox.confirm('Confirmation','Are you sure to delete this record?', detail_jpgrooming_delete);
		} else if(detail_jpgroomingListEditorGrid.selModel.getCount() > 1){
			Ext.MessageBox.confirm('Confirmation','Are you sure to delete these records?', detail_jpgrooming_delete);
		} else {
			Ext.MessageBox.show({
				title: 'Warning',
