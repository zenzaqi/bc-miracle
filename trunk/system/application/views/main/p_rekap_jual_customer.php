...
<thead> 
	<tr> 
		...
		<th scope='col'>Voucher NonMedis(Rp)</th>
		<th scope='col'>Voucher Medis(Rp)</th>
		<?//<th scope='col'>Disk (%)</th>	<th scope='col'>Disk (Rp)</th>?>
	...
	<tr> 
		...
		<td colspan="13"><b><?php echo $print->cust_nama." (".$print->cust_no.")"; ?></b></td> 
	</tr>
		<?php 
			$sub_cashback=0;
	...
	<tr> 
		<td><?php echo $i; ?></td>
		<td><?php echo $print_list->tanggal; ?></td> <td><?php echo $print_list->no_bukti; ?></td>
	...
	</tr> <?php } $cust=$print->cust_id; ?><?php } ?>
</tbody> 
<tfoot> 
	<tr> 
		<td class="clear">&nbsp;</td> <th scope='row'>Total</th> 
	...
	<tr> 
		...
		<td nowrap="nowrap" align="right" class="numeric clear"><?php echo number_format($total_nilai,0,",",","); ?></td> <td colspan='11' class="clear" >&nbsp;</td> 
	</tr>
	<tr> 
		<td class="clear">&nbsp;</td> 
	...
	<tr> 
		...
		<td colspan='11' class="clear" >&nbsp;</td> </tr> 
	<tr> 
	...
	<tr> 
		<td class="clear">&nbsp;</td> 
		<th scope='row' nowrap="nowrap">Total Kredit (Rp)</th> <td nowrap="nowrap" align="right" class="numeric clear"><?php echo number_format($total_kredit,0,",",","); ?></td> 
		<td colspan='11' class="clear" >&nbsp;</td> 
	</tr>
</tfoot>
</table></body></html>