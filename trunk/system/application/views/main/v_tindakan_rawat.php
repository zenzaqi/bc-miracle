...
Ext.onReady(function(){
	...
	function tindakan_rawat_confirm_delete(){
		...
		if(tindakan_rawatListEditorGrid.selModel.getCount() == 1){
			Ext.MessageBox.confirm('Confirmation','Apakah Anda yakin akan menghapus data berikut?', tindakan_rawat_delete);
		} else if(tindakan_rawatListEditorGrid.selModel.getCount() > 1){
			Ext.MessageBox.confirm('Confirmation','Apakah Anda yakin akan menghapus data-data berikut?', tindakan_rawat_delete);
		} else {
			Ext.MessageBox.show({
				title: 'Warning',
	...
	function tindakan_rawat_detail_confirm_delete(){
		...
		if(tindakan_rawat_detailListEditorGrid.selModel.getCount() == 1){
			Ext.MessageBox.confirm('Confirmation','Apakah Anda yakin akan menghapus data berikut?', tindakan_rawat_detail_delete);
		} else if(tindakan_rawat_detailListEditorGrid.selModel.getCount() > 1){
			Ext.MessageBox.confirm('Confirmation','Apakah Anda yakin akan menghapus data-data berikut?', tindakan_rawat_detail_delete);
		} else {
			Ext.MessageBox.show({
				title: 'Warning',
				msg: 'Tidak ada yang dipilih untuk dihapus',
