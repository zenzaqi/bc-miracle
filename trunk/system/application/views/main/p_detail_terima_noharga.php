...
<title>Laporan Detail Penerimaan Barang  <?php echo $periode; ?> Group By No. Faktur</title>
...
<table summary='Detail Jual'>
	...
	<tbody>
           ...
           <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="7"><b><?php echo "No Faktur: ".$print->no_bukti.", Tanggal : ".$print->tanggal.", Supplier: ".$print->supplier_nama."(".$print->supplier_akun.")";?></b></td>
           </tr>
           <?php
