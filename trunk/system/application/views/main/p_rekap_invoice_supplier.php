...
<title>Laporan Rekap Penerimaan Tagihan <?php echo $periode; ?> Group By Supplier</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Rekap Pesanan Pembelian'>
	<caption>Laporan Penerimaan Tagihan <br/><?php echo $periode; ?><br/>Group By Supplier</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
