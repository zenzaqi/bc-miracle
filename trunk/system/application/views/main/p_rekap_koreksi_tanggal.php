...
<title>Laporan Rekap Penyesuaian Stok <?php echo $jenis; ?> <?php echo $periode; ?> Group By Tanggal</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Rekap Penyesuaian Stok'>
	<caption>Laporan Rekap Penyesuaian Stok <br/><?php echo $periode; ?><br/>Group By Tanggal</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
        ...
        <tr>
        	...
        	<td colspan="5"><b><?php echo $printlist->tanggal; ?></b></td>
        </tr>
        		<?php
					$sub_awal=0;
					$sub_koreksi=0;
