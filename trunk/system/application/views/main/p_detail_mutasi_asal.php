...
<title>Laporan Detail Mutasi <?php echo $jenis; ?> <?php echo $periode; ?> Group By Gudang Asal</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Rekap Jual'>
	<caption>Laporan Detail Mutasi <br/><?php echo $periode; ?><br/>Group By Gudang Asal</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>   
	...
	<tbody>
		<?php 	$i=0; 
			...
			<?php if($group!==$printgroup->mutasi_asal) { ?>
           <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="5"><b><?php echo $printgroup->gudang_asal_nama;?></b></td>
           </tr>		
       <?
	   	$sub_total=0;
		$i=0;
		foreach($data_print as $print) { 
			...
			if($print->mutasi_asal==$printgroup->mutasi_asal){  
