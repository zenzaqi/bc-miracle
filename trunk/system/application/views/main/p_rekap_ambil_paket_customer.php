...
<title>Laporan Rekap Pengambilan Paket <?php echo $periode; ?> Group By Customer</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table width="1201" summary='Rekap Jual'>
	<caption>
	Laporan Rekap Pengambilan Paket<br/><?php echo $periode; ?>Group By Customer</caption>
	<thead>
    	<tr>
        	<th width="22" scope='col'>No</th>
            <th width="80" scope='col'>No Faktur</th>           
            <th width="80" scope='col'>Tanggal</th>
            <th width="700" scope='col'>Nama Paket</th>
	...
	<tbody>
		...
		?>
         <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="6"><b><?php echo $printlist->cust_nama." (".$printlist->cust_no.")";?></b></td>
         </tr>
        <?
				$i=0;
