...
<title>Laporan Detail Retur Penjualan <?php echo $periode; ?> Group by Produk</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print()">
<table summary='Detail Retur Jual'>
	<caption>Laporan Detail Retur Penjualan <br/><?php echo $periode; ?> <br/>Group by Produk</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
    ...
    <tbody>
		...
		foreach($data_print as $printlist) { $i++; 
			...
			if($group!==$printlist->produk_kode){
			$j++;
		?>
        <tr>
        	<td scope='col'><b><?php echo $j; ?></b></td>
            <td scope='col' colspan="11"><b><?php echo $printlist->produk_nama." (".$printlist->produk_kode.")"; ?></b></td>
        </tr>
        <?php
			...
			$i=0;
				...
				foreach($data_print as $print) { 
					...
					if($print->produk_kode==$printlist->produk_kode){
						$i++;
