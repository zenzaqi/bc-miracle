...
<title>Laporan Detail Penyesuaian Stok <?php echo $periode; ?> Group By Gudang</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Detail Jual'>
	<caption>Laporan Detail Penyesuaian Stok <br/><?php echo $periode; ?><br/>Group By Gudang</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
			...
			?>
			<?php if($group!==$print->gudang_id) { ?>
           <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="7"><b><?php echo $print->gudang_nama; ?></b></td>
           </tr>
           <?php 	
		   			$sub_awal=0;
					$sub_koreksi=0;
           ...
           <?php if($print_list->gudang_id==$print->gudang_id){ $i++;
