...
<title>Laporan Tindakan Non Medis <?php echo $periode; ?> Group By Status</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Detail Jual'>
	<caption>Laporan Tindakan Non Medis <br/><?php echo $periode; ?><br/>Group By Status</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
