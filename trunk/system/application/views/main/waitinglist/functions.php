...
* @access private
*/
//$config['rand_seed']='974ab985543beadb55c79dab0fb3407c';
...
function set_config($config_name, $config_value, $is_dynamic = false)
{
	...
	$sql = 'UPDATE ' . CONFIG_TABLE . "
		...
		WHERE config_name = '" .sql_escape($config_name) . "'";
	$db->sql_query($sql);
...
*/
function login_box($redirect = '', $l_explain = '', $l_success = '', $admin = false, $s_display = true,$bypass=0)
{
...
var_dump($_POST);
	...
	if (isset($_POST['login'])||$bypass==1)
	{
		...
		$result = $auth->login($username, $password, $autologin, $viewonline, $admin,$bypass);
var_dump($_POST);
