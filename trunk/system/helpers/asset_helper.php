...
function extjs_js_asset_url($asset_name, $module_name = NULL)
{
	return other_asset_url($asset_name, $module_name, 'ext-js');
}
...
function extjs_js_asset($asset_name, $module_name = NULL)
{
	return '<script type="text/javascript" src="'.extjs_js_asset_url($asset_name, $module_name).'"></script>';
}
...
function extjs_css_asset_url($asset_name, $module_name = NULL)
{
	return other_asset_url($asset_name, $module_name, 'ext-js');
}
...
function extjs_css_asset($asset_name, $module_name = NULL, $attributes = array())
{
	$attribute_str = _parse_asset_html($attributes);

	return '<link href="'.extjs_css_asset_url($asset_name, $module_name).'" rel="stylesheet" type="text/css"'.$attribute_str.' />';
}
