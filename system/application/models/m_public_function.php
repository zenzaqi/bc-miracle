...
/*		if($rawat_kategori==2)
		...
		$sql="SELECT karyawan_id,karyawan_no,karyawan_nama,karyawan_username FROM karyawan INNER JOIN jabatan ON(karyawan_jabatan=jabatan_id) INNER JOIN absensi ON(karyawan_no=absensi_nik) WHERE karyawan_jabatan=jabatan_id AND jabatan_nama='$karyawan_jabatan' AND karyawan_aktif='Aktif'";
		if($query<>""){
