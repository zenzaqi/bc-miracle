...
class M_kartu_rekomendasi extends Model{
	...
	*/
	...
	function detail_tindakan_medis_detail_insert($dtrawat_id ,$dtrawat_master ,$dtrawat_perawatan ,$dtrawat_petugas1 ,$dtrawat_petugas2, $dtrawat_status ,$dtrawat_keterangan ,$dtrawat_ambil_paket ,$dtrawat_cust){
	...
	function tindakan_update($trawat_id ,$trawat_cust ,$trawat_keterangan ,$dtrawat_status ,$trawat_cust_id ,$dtrawat_perawatan_id ,$dtrawat_perawatan ,$dtrawat_id ,$rawat_harga ,$rawat_du ,$rawat_dm ,$cust_member ,$dtrawat_dokter ,$dtrawat_dokter_id ,$dtrawat_keterangan ,$dtrawat_dapp ,$dtrawat_ambil_paket ,$dpaket_id ,$rpaket_perawatan ,$mode_edit){
		...
		function tindakan_create($trawat_cust ,$card_dokter, $trawat_keterangan, $card_wl1, $card_wl2, $card_wl3, $card_wl4, $card_wl5, $card_wl6, $card_wl7, $card_wl8, $card_wl9, $card_wl10, $card_wl11, $card_wl12, $card_wl13, $card_wl14, $card_wl15, $card_wl16, $card_wl17, $card_wl18, $card_wl19, $card_wl20, $card_wl21, $card_wl22){
			$time_now=date('H:i:s');
			$date_now=date('Y-m-d');
			$data = array(
