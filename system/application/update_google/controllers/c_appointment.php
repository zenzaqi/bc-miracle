...
class C_appointment extends Controller {
	...
	function  detail_appointment_detail_list(){
		...
		$result=$this->m_appointment->detail_appointment_detail_list($master_id,$query,$start,$end);
		echo $result;
	}
	//end of handler
	...
	//POST variable here
		...
		$dapp_jamdatang=str_replace("'", "\'",$dapp_jamdatang);
		$result=$this->m_appointment->detail_appointment_detail_insert($dapp_id ,$dapp_master ,$dapp_perawatan ,$dapp_tglreservasi ,$dapp_jamreservasi ,$dapp_petugas ,$dapp_petugas2 ,$dapp_status ,$dapp_tgldatang ,$dapp_jamdatang );
	}
	...
	function appointment_update(){
		...
		$app_keterangan=str_replace("'", "\'",$app_keterangan);
		$result = $this->m_appointment->appointment_update($app_id ,$app_customer ,$app_tanggal ,$app_cara ,$app_keterangan      );
		echo $result;
	}
