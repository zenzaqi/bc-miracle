...
<title>Laporan Detail Mutasi <?php echo $jenis; ?> <?php echo $periode; ?> Group By Gudang Tujuan</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Rekap Jual'>
	<caption>Laporan Detail Mutasi <br/><?php echo $periode; ?><br/>Group By Gudang Tujuan</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>   
