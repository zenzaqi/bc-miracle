...
<title>Laporan Detail Pesanan Pembelian <?php echo $jenis; ?> <?php echo $periode; ?></title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body>
<table summary='Detail Jual'>
	<caption>Laporan Detail Pesanan Pembelian <?php echo $jenis; ?><br/><?php echo $periode; ?><br/>Group By No. Faktur</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
