			...
			<tr>
				...
				<td>
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tr class="clear">
							<td  class="clear" align="right">Dibayarkan kepada</td><td class="clear">:</td><td class="clear"><?php echo $terima_untuk; ?></td>
						</tr>
					</table>
				</td>
			</tr>
