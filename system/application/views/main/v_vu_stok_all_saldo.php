...
Ext.onReady(function(){
	...
	vu_stok_all_saldo_DataStore = new Ext.data.Store({
		...
		/* dataIndex => insert intovu_stok_all_saldo_ColumnModel, Mapping => for initiate table column */ 
		...
		items:[
			{
				...
				layout: 'form',
				border:false,
				items: [produk_kodeField,produk_namaField,satuan_namaField,stok_saldoField] 
			}
			],
		buttons: [{
				text: 'Close',
	...
	vu_stok_all_saldo_searchForm = new Ext.FormPanel({
		...
		items: [{
			...
			items:[
			{
				...
				layout: 'form',
				border:false,
				items: [produk_idSearchField,produk_namaSearchField,satuan_namaSearchField,stok_saldoSearchField] 
			}
			]
		}]
		,
	...
	vu_stok_all_saldo_searchWindow = new Ext.Window({
		title: 'vu_stok_all_saldo Search',
		closable:true,
		closeAction: 'hide',
		autoWidth: true,
		autoHeight: true,
