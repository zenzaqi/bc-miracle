...
<title>Laporan Rekap Retur Paket <?php echo $periode; ?> Group By No Faktur Jual</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print()">
<table summary='Rekap Retur Jual'>
	<caption>Laporan Rekap  Retur Paket <br/><?php echo $periode; ?> <br/>Group By No Faktur Jual</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
