		...
		items:[
			{
				...
				labelAlign: 'left',
				border:false,
				items: [produk_harga_thField, produk_harga_kiField,produk_harga_mdnField, produk_harga_mndField, produk_harga_ygkField, produk_harga_mtaField, produk_harga_lbkField, produk_harga_hrField]
			}
		]
	});
