...
<title>Laporan Rekap Penjualan <?php echo $jenis; ?> Periode <?php echo $tgl_awal." s/d ".$tgl_akhir; ?></title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body>
<table summary='Rekap Jual'>
	<caption>Laporan Rekap Penjualan <?php echo $jenis; ?><br/>Periode <?php echo $tgl_awal." s/d ".$tgl_akhir; ?></caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
