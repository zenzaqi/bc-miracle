...
<title>Laporan Detail Pengambilan Paket <?php echo $periode; ?> Group By Referal</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table width="731" summary='Detail Jual'>
	<caption>
	Laporan Detail Pengambilan Paket<br/><?php echo $periode; ?><br/>Group By Referal</caption>
	<thead>
    	<tr>
            ...
            <th width="200" scope='col'>Perawatan</th>
	...
	<tbody>
		...
		foreach($data_print as $print) { 
				if($print->referal==$printlist->referal){ $i++;
		?>
		<tr>
        	<td><? echo $i; ?></td>
