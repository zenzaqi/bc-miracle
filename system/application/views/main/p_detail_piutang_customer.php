...
<title>Laporan Detail Piutang dan Pelunasannya <?php echo $periode; ?> Group By Customer</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Laporan Detail Piutang dan Pelunasannya '>
	<caption>Laporan Detail Piutang dan Pelunasannya <br/><?php echo $periode; ?> <br/>Group By  Customer</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
		...
		foreach($data_print as $print) { ?>
			<?php 
					if($cust!==$print->cust_id) { 
					//	if(is_null($tanggal) || $tanggal=="" || $tanggal==NULL) $tanggal="-";
			?>
		  <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="9"><b><?php echo $print->cust_nama." (".$print->cust_no.")";?></b></td>
           </tr>
           <?php 	$sub_nilai=0;
					$i=0; 
			?>
           <?php foreach($data_print as $print_list) {  ?>
           <?php if($print_list->cust_id==$print->cust_id && $print_list->dpiutang_nilai>0){ 
		   			$k++;
					$i++;
