...
<title>Kas Bank Keluar List</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<table summary='Tbl T Jurnal List'>
	<caption>Kas Bank Keluar List</caption>
	<thead>
		<tr>
			<th scope='col'>No</th>
	...
	<tbody>
		<?php $i=0; $total=0; foreach($data_print as $print) { $i++; $total+=$print->kasbank_kredit; ?>
		<tr>
			<td><? echo $i; ?></td>
			...
			<td class="numeric" align="right"><?php echo number_format($print->kasbank_kredit); ?></td>
