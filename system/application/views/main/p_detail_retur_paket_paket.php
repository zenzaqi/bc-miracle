...
<title>Laporan Detail Retur Paket <?php echo $periode; ?> Group by Paket</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print()">
<table summary='Detail Retur Jual'>
	<caption>Laporan Detail Retur Paket <br/><?php echo $periode; ?> <br/>Group by Paket</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
    ...
    <tbody>
		...
		foreach($data_print as $printlist) { $i++; 
			...
			if($group!==$printlist->paket_kode){
			$j++;
		?>
        <tr>
        	<td scope='col'><b><?php echo $j; ?></b></td>
            <td scope='col' colspan="11"><b><?php echo $printlist->paket_nama." (".$printlist->paket_kode.")"; ?></b></td>
        </tr>
        <?php
			...
			$i=0;
				...
				foreach($data_print as $print) { 
					...
					if($print->paket_kode==$printlist->paket_kode){
						$i++;
