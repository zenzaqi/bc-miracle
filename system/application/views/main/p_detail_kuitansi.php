...
<title>Laporan Detail Pemakaian Kuitansi <?php echo $periode; ?> Group By No Kuitansi</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Rekap Jual'>
	<caption>Laporan Detail Pemakaian Kuitansi <br/><?php echo $periode; ?><br/>Group By No Kuitansi</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
		...
		<tr>
        	<td><? echo $i; ?></td>
            <td width="10"><?php echo $print_list->cust_nama." (".$print_list->cust_no.")"; ?></td>
