		...
		items:[
			{
				...
				labelWidth: 120,
				border:false,
				items: [paket_kodelamaField, paket_kodeField, paket_namaField, paket_groupField, paket_hargaField, paket_harga_checkField,paket_duField, paket_dmField,paket_hargaGroup]
			}
			,{
				columnWidth:0.5,
				layout: 'form',
