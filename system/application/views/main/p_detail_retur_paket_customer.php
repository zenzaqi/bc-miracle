...
<title>Laporan Detail Retur Paket <?php echo $periode; ?> Group by Customer</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print()">
<table summary='Detail Retur Jual'>
	<caption>Laporan Detail Retur Paket <br/><?php echo $periode; ?> <br/>Group by Customer</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
