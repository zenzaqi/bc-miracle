...
<title>Laporan Detail Penjualan <?php echo $jenis; ?> <?php echo $periode; ?> Group By Sales</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Detail Jual'>
	<caption>Laporan Detail Penjualan <?php echo $jenis; ?><br/><?php echo $periode; ?>Group By  Sales</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
        ...
        <?php $i=0; $j=0; $sales=""; foreach($data_print as $print) { ?>
			<?php if($sales!==$print->sales) { ?>
           <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="12"><b><?php 
				$nama_sales = $print->sales;
				if ($print->sales == '')
					$nama_sales = 'Tidak Ada Referal';
				
				echo $nama_sales;?></b></td>
           </tr>
           <?php $sub_cashback=0;
					$sub_total=0;
					$sub_diskon=0;
           ...
           <?php if($print_list->sales==$print->sales){ $i++;
