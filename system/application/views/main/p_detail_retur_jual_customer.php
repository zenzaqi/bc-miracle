...
<title>Laporan Detail Retur Penjualan <?php echo $periode; ?> Group by Customer</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print()">
<table summary='Detail Retur Jual'>
	<caption>Laporan Detail Retur Penjualan <br/><?php echo $periode; ?> <br/>Group by Customer</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
    ...
    <tbody>
		...
		foreach($data_print as $printlist) { $i++; 
			...
			if($group!==$printlist->cust_id){
			$j++;
		?>
        <tr>
        	<td scope='col'><b><?php echo $j; ?></b></td>
            <td scope='col' colspan="11"><b><?php echo $printlist->cust_nama." (".$printlist->cust_id.")"; ?></b></td>
        </tr>
        <?php
			...
			$i=0;
				...
				foreach($data_print as $print) { 
					...
					if($print->cust_id==$printlist->cust_id){
						$i++;
