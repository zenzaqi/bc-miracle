...
<title>Laporan Detail Pesanan Penjualan <?php echo $jenis; ?> <?php echo $periode; ?></title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body>
<table summary='Detail Pesanan Penjualan'>
	<caption>Laporan Detail Pesanan Penjualan <?php echo $jenis; ?><br/><?php echo $periode; ?><br/>Group By Produk</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
            <th scope='col'>Tanggal</th>
            <th scope='col'>No Faktur</th>
            <th scope='col'>supplieromer</th>
