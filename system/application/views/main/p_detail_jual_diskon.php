...
<title>Laporan Detail Penjualan <?php echo $jenis; ?> <?php echo $periode; ?> Group By Jenis Diskon</title>
<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Detail Jual'>
	<caption>Laporan Detail Penjualan <?php echo $jenis; ?><br/><?php echo $periode; ?><br/>Group By Jenis Diskon</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
        ...
        <?php $i=0; $j=0; $jdiskon=""; foreach($data_print as $print) { ?>
			<?php if($jdiskon!==$print->diskon_jenis) { ?>
           <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="12"><b><?php echo $print->diskon_jenis;?></b></td>
           </tr>
           <?php $sub_cashback=0;
					$sub_total=0;
					$sub_diskon=0;
           ...
           <?php if($print_list->diskon_jenis==$print->diskon_jenis){ $i++;
		   ...
		   ?>
            <tr>
                ...
                <td class="numeric"><?php echo $print_list->sales; ?></td>
           ...
           <?php } $jdiskon=$print->diskon_jenis; ?>
		<?php } ?>
